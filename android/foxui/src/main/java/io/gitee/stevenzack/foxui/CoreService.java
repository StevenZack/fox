...
public class CoreService extends Service {
    ...
    public void onCreate() {
        ...
        if (onCreate != null && !onCreate.equals("")) {
            showNtf();
            Fox.triggerFunction(null, onCreate, "", "", "");
        }
    }
    ...
    private void showNtf() {
        final String NOTIFICATION_CHANNEL_ID = "jywjl_notification_channel";
        NotificationManager notificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Jywjl_Notifications", NotificationManager.IMPORTANCE_LOW);
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(getApplicationContext(), 2345, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        builder.setSound(null);
    ...
    private void listener(RemoteViews remoteViews, Context context) {
        Intent intent2 = new Intent("QuitJywjlService");
        PendingIntent pendingIntent2 = PendingIntent.getBroadcast(context, 2345, intent2, 0);
        ...
        BroadcastReceiver receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals("QuitJywjlService")) {
                    Fox.triggerFunction(null, onQuitClick, "", "", "");
                }
            }
        };
